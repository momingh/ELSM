...
def get_reco_dataset(
    ...
    if dataset_name == "ml-1m":
        ...
        dataset_name == "amzn-beauty5" or dataset_name == "amzn-pantry5" or dataset_name == "amzn-office5" or dataset_name == "amzn-pantry" or dataset_name == "amzn-office" or dataset_name == "amzn-arts" or dataset_name == "amzn-scientific" or dataset_name == "amzn-instruments"
    ):
        dp = get_common_preprocessors()[dataset_name]
        train_dataset = DatasetV2(
            ratings_file=dp.output_format_csv(),
