...
class LocalNegativesSampler(NegativesSampler):
    ...
    def forward(
        ...
        # return sampled_ids, self.normalize_embeddings(self._item_emb(sampled_ids)+self._text_emb(sampled_ids)+\
        #                                               self._image_emb(sampled_ids))
        # return sampled_ids, self.normalize_embeddings(self.fusion_model([self._item_emb(sampled_ids), self._image_emb(sampled_ids), self._text_emb(sampled_ids)]))
        return sampled_ids, self.normalize_embeddings(self.fusion_model(sampled_ids))

        # return sampled_ids, self.normalize_embeddings(self._item_emb(sampled_ids))
        # return sampled_ids, self.normalize_embeddings(self._text_emb(sampled_ids)+self._image_emb(sampled_ids))
