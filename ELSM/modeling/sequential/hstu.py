...
class HSTU(GeneralizedInteractionModule):
    ...
    def get_item_embeddings_forward(self, ids: torch.Tensor) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
        return self._embedding_module.ELSM(ids)
...
def CE(P,Q,mask=None):
    # cosine & distance distribution should not be similar
