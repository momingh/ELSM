...
def get_eval_state(
    ...
    eval_negative_embeddings = negatives_sampler.normalize_embeddings(
        ...
        model.get_item_embeddings_forward(eval_negatives_ids)
    )
...
def eval_metrics_v2_from_tensors(
    ...
    shared_input_embeddings = model.encode(
        ...
        past_embeddings=model.get_item_embeddings_forward(seq_features.past_ids),
        # past_embeddings=model.fusion_emb(model.get_item_embeddings_forward(seq_features.past_ids)),
